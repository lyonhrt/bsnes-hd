...
auto ToolsWindow::create() -> void {
  ...
  panelList.append(ListViewItem().setText("HD Pack Builder").setIcon(Icon::Action::Add));
  panelList.onChange([&] {
  ...
  panelContainer.append(hdPackBuilder, Size{~0, ~0});
...
auto ToolsWindow::show(int index) -> void {
  ...
  hdPackBuilder.setVisible(false);
  ...
  if(index == 4) hdPackBuilder.setVisible(true);
